...
(async () => {
  ...
  try {
    ...
    console.log(JSON.stringify({result:'PASS',checks:['exact-key login','settings geometry','modal focus/secret clearing','documentation full-text/clear/scroll','update dimensions/save gate','mobile width'],screenshots:directory}));
  } finally {
